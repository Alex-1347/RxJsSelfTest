// Creating new operators from scratch https://rxjs.dev/guide/operators
...
function delay<T>(delayInMillis: number) {
    return (observable: Observable<T>) =>
        new Observable<T>((subscriber) => {
            ...
            // Return the finalization logic. This will be invoked when the result errors, completes, or is unsubscribed.
            return () => {
